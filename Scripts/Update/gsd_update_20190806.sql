ALTER TABLE dbo.SO_Plan_2nd_Tmp ADD
	SAM_beforePPE decimal(13, 2) NULL,
	SAM_afterPPE decimal(13, 2) NULL
GO
...
ALTER TABLE dbo.SO_Plan ALTER COLUMN [Customer_Dept_Name] varchar(40) null;
GO
ALTER TABLE dbo.SO_Plan_tmp ALTER COLUMN [Customer_Dept_Name] varchar(40) null;
GO
ALTER TABLE dbo.SO_Plan_Hist ALTER COLUMN [Customer_Dept_Name] varchar(40) null;
GO

ALTER TABLE dbo.SO_Plan_Detail_tmp ALTER COLUMN [Customer_Dept_Name] varchar(40) null;
GO
ALTER TABLE dbo.SO_Plan_Detail_hist ALTER COLUMN [Customer_Dept_Name] varchar(40) null;
GO
ALTER TABLE dbo.SO_Plan_Detail ALTER COLUMN [Customer_Dept_Name] varchar(40) null;
GO

--------
USE [GSDDB]
GO
/****** Object:  StoredProcedure [dbo].[p_InsertSo_Plan_Detail_Temp]    Script Date: 06/08/2019 11:04:28 AM ******/
SET ANSI_NULLS ON
GO
...
ALTER procedure [dbo].[p_InsertSo_Plan_Detail_Temp]
	...
	@Customer_Dept_Name varchar(40) ,
	@Customer_Dept_Code varchar(15) ,
	...
	@FusingCMCost decimal(13, 2) ,
	@OfflineSeamsealCMCost decimal(13, 2) ,
	@LaserCutCMCost decimal(13, 2) ,
	@AirWashingCost decimal(13, 2) ,
	@GarmentDyeingCost decimal(13, 2) ,
	@NonClaimAirMatCost decimal(13, 2) ,
	@NonClaimAirGmtCost decimal(13, 2) ,
	@OrderIndicator varchar(10)	,
	@BuyMonth datetime,
	@StripeCutQty varchar(15),
	@ShipmentStatus varchar(1),
	@PPCDate datetime,
	@SODate datetime,
	@BondingCostT decimal(13, 2) ,
	@CG varchar(10) ,
	@PricingDate datetime ,
	@SpecialProcessKnitting decimal(13, 2) ,
	@SAM_beforePPE decimal(13, 2),
	@SAM_afterPPE decimal(13, 2)
AS 
BEGIN
SET NOCOUNT ON
...
USE [GSDDB]
GO
/****** Object:  StoredProcedure [dbo].[p_InsertSo_Plan_2nd_Temp]    Script Date: 06/08/2019 11:04:02 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
ALTER procedure [dbo].[p_InsertSo_Plan_2nd_Temp]
	...
	@BuyMonth datetime ,
	@StripeCutQty varchar(15),
	@EstLoadDate datetime ,
	@PackageDeal varchar(50) ,
	@LaserLicense decimal(13, 2) ,
	@EMFCost decimal(13, 2)	,
	@PPCDate datetime,
	@CG varchar(10) ,
	@PricingDate datetime ,
	@SpecialProcessKnitting decimal(13, 2) ,
...
USE [GSDDB]
GO
/****** Object:  StoredProcedure [dbo].[p_InsertSo_Plan_Temp]    Script Date: 30/08/2019 2:09:28 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
