ALTER TABLE [SO_Plan]
ALTER COLUMN [Customer_Program] varchar(80)
GO

ALTER TABLE [SO_Plan_Hist]
ALTER COLUMN [Customer_Program] varchar(80)
GO

ALTER TABLE [SO_Plan_Tmp]
ALTER COLUMN [Customer_Program] varchar(80)
GO

-----------

/****** Object:  StoredProcedure [dbo].[p_InsertSo_Plan_Temp]    Script Date: 07/31/2017 11:58:38 ******/
SET ANSI_NULLS ON
GO
